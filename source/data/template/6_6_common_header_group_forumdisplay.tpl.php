...
0
|| checktplrefresh('./template/mobanbus_h5cpv1/common/header.htm', './template/mobanbus_h5cpv1/common/header_common.htm', 1496800563, '6', './data/template/6_6_common_header_group_forumdisplay.tpl.php', './template/mobanbus_h5cpv1', 'common/header_group_forumdisplay')
|| checktplrefresh('./template/mobanbus_h5cpv1/common/header.htm', './template/mobanbus_h5cpv1/common/pubsearchform.htm', 1496800563, '6', './data/template/6_6_common_header_group_forumdisplay.tpl.php', './template/mobanbus_h5cpv1', 'common/header_group_forumdisplay')
|| checktplrefresh('./template/mobanbus_h5cpv1/common/header.htm', './template/default/common/header_qmenu.htm', 1496800563, '6', './data/template/6_6_common_header_group_forumdisplay.tpl.php', './template/mobanbus_h5cpv1', 'common/header_group_forumdisplay')
;?>
<!doctype html>
