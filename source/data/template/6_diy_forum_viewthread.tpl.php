...
0
|| checktplrefresh('data/diy/./template/mobanbus_h5cpv1//forum/viewthread.htm', './template/mobanbus_h5cpv1/forum/viewthread_node.htm', 1496222157, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/mobanbus_h5cpv1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/mobanbus_h5cpv1//forum/viewthread.htm', './template/mobanbus_h5cpv1/forum/viewthread_fastpost.htm', 1496222157, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/mobanbus_h5cpv1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/mobanbus_h5cpv1//forum/viewthread.htm', './template/mobanbus_h5cpv1/forum/forumdisplay_busyt.htm', 1496222157, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/mobanbus_h5cpv1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/mobanbus_h5cpv1//forum/viewthread.htm', './template/mobanbus_h5cpv1/forum/viewthread_node_body.htm', 1496222157, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/mobanbus_h5cpv1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/mobanbus_h5cpv1//forum/viewthread.htm', './template/mobanbus_h5cpv1/forum/viewthread_node_body.htm', 1496222157, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/mobanbus_h5cpv1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/mobanbus_h5cpv1//forum/viewthread.htm', './template/default/common/seditor.htm', 1496222157, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/mobanbus_h5cpv1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/mobanbus_h5cpv1//forum/viewthread.htm', './template/default/common/seccheck.htm', 1496222157, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/mobanbus_h5cpv1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/mobanbus_h5cpv1//forum/viewthread.htm', './template/default/common/upload.htm', 1496222157, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', 'data/diy/./template/mobanbus_h5cpv1/', 'forum/viewthread')
;
block_get('106,107');?><?php include template('common/header'); ?><script src="template/mobanbus_h5cpv1/mobanbus_st/js/bus_fixed.js" type="text/javascript"></script>
...
<!--[diy=diynavtop]--><div id="diynavtop" class="area"></div><!--[/diy]--><?php echo adshow("text/wp a_t");?><style id="diy_style" type="text/css"></style>
...
<div id="post_<?php echo $post['pid'];?>" <?php if($_G['blockedpids'] && $post['inblacklist']) { ?>style="display:none;"<?php } ?> class="<?php if($post['first']) { ?>mobanbus_auther<?php } else { ?>mobanbus_reply<?php } ?>">
  <div><?php $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);
...
<span>回复:<?php echo $_G['forum_thread']['allreplies'];?></span>
<span class="pipe show">|</span>
<span>查看:<?php echo $_G['forum_thread']['views'];?></span>
<span class="pipe show">|</span>
...
<?php } ?>
<span class="pipe show">|</span><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php echo $fromuid;?>" onclick="return copyThreadUrl(this, '<?php echo $_G['setting']['bbname'];?>')" <?php if($fromuid) { ?>title="您的朋友访问此链接后，您将获得相应的积分奖励"<?php } ?>>复制链接</a>
</span>
</div>
</div>
...
<div id="fj" class="y">
                        ...
                        <span class="y bus_jp" style=" width:26px;">
                        	<input type="text" class="p_fre z" size="2" onkeyup="$('fj_btn').href='forum.php?mod=redirect&ptid=<?php echo $_G['tid'];?>&authorid=<?php echo $_GET['authorid'];?>&postno='+this.value" onkeydown="if(event.keyCode==13) {window.location=$('fj_btn').href;return false;}" title="跳转到指定楼层" />
...
<div id="f_pst" class="pl<?php if(empty($_GET['from'])) { ?> bmw<?php } ?> bus_viewthread_br">
...
<textarea rows="6" cols="80" name="message" id="fastpostmessage" onKeyDown="seditor_ctlent(event, <?php if($_GET['ordertype'] != 1) { ?>'fastpostvalidate($(\'fastpostform\'))'<?php } else { ?>'$(\'fastpostform\').submit()'<?php } ?>);" tabindex="4" <?php echo getreplybg($_G['forum']['replybg']);?>></textarea>
<?php } else { ?>
<div class="pt hm">
...
<span class="y">
<a class="lb" href="home.php?mod=spacecp&amp;ac=credit&amp;op=rule&amp;fid=<?php echo $_G['fid'];?>" target="_blank">本版积分规则</a>
...
<!-- bus_sidebox end -->
<div class="clear"></div>
<!--[diy=diy_bus_rightbox]--><div id="diy_bus_rightbox" class="area"><div id="frameZlzmO4" class="frame move-span cl frame-1"><div id="frameZlzmO4_left" class="column frame-1-c"><div id="frameZlzmO4_left_temp" class="move-span temp"></div><?php block_display('106');?><?php block_display('107');?></div></div></div><!--[/diy]-->
<div class="clear"></div>
</aside>
...
<?php if(!IS_ROBOT) { ?>
<a class="bus_arrows prev" href="forum.php?mod=redirect&amp;goto=nextoldset&amp;tid=<?php echo $_G['tid'];?>" title="上一主题"></a>
<a class="bus_arrows next" href="forum.php?mod=redirect&amp;goto=nextnewset&amp;tid=<?php echo $_G['tid'];?>" title="下一主题"></a>
<?php } ?>
